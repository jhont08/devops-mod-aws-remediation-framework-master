...
def audit(resource, remediate=False, create_issues=False):
    ...
    # DESCOMENTAR CUANDO SE SOPORTE IMDSv2 EN LAS CELULAS
    #if (
    ...
    #):
        ...
        #if remediate:
        #    if remediation_enforce_IMDSv2(ec2, resource):
        #        issue += " - Remediated"
        #        if remediation_create_tag(ec2, resource["id"]):
        #            issue += " - Tagged"
        #    else:
    ...
    #DESCOMENTAR CUANDO SE VALIDEN LOS TAGS LUEGO DE LA CREACION
    ...
    #        else:
    #            issue += " - Not remediated"
    #    send_notification(issue, "Required tags: {}".format(", ".join(get_required_tags())), resource)
    return is_compliant
...
def remediation_create_tag(ec2, instance_id):
    print("Creating Tag: - {}".format(instance_id))
    ec2.create_tags(
