...
def handler(event, context, remediate=False, create_issues=False):
    ...
    if os.environ.get("CREATE_ISSUES", "") != "":
        if os.environ["CREATE_ISSUES"].lower() == "true":
            create_issues = True
    ...
    for record in event["Records"]:
        ...
        try:
            ...
            if (resource["account"] in custom_module_exception.keys() and resource[
                ...
                remediate = False
                resource_module.audit(resource, remediate, create_issues)
            else:
                resource_module.audit(resource, remediate, create_issues)
...
if __name__ == "__main__":
    ...
    for line in sys.stdin:
        ...
        handler(event, None, remediate=args.remediate, create_issues=args.create_issues)
